...
//        初始化字体样式
    ...
    private void initViews() {
        mScrollView = (ScrollView) findViewById(R.id.story_scrollview);
        mAudioHomeBanner = (Banner) findViewById(R.id.audio_story_banner0);
        mAudioHomeBanner1 = (Banner) findViewById(R.id.audio_story_banner1);
...
//                show("单击了广告" + position);
        ...
        mAudioHomeBanner.setImages(images1, new Banner.OnLoadImageListener() {
            ...
            public void OnLoadImage(ImageView view, Object url) {
                Glide.with(StoryXuetangActivity.this).load(url).into(view);
            }
        });
        //设置轮播图圆点样式
        //显示小圆点
