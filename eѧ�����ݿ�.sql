...
CREATE table child(
	...
	child_sex              char(2),          	##(性别)
	child_school_class_name      varchar(100),  ##(学校名称及班级)
	...
	child_dream            varchar(50),			##(孩子梦想)
	child_hobby            varchar(20),      	##(宝宝特长)
	child_trainplan        varchar(100),		##(宝宝培训计划)
...
##competition报名表：competition(先不弄)
...
##contestinfo比赛信息表：contestinfo(先不弄)
