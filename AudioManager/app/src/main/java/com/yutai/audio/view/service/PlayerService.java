package com.yutai.audio.view.service;
...
public class PlayerService extends Service {
	...
	public void initLrc(){
		...
		//读取歌词文件
		mLrcProcess.readLRC(mp3Infos.get(current).getMusic_path_lrc());
		//传回处理后的歌词文件
