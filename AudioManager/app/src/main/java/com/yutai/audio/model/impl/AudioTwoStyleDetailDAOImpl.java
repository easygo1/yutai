...
public class AudioTwoStyleDetailDAOImpl implements AudioTwoStyleDetailDAO {
    ...
    public List<Music> getData(int tabstyle, int cur, AudioTwoStyleDetailPresenter twoStyleDetailPresenter) {
        ...
        switch (tabstyle) {
            ...
            case 2:
                // 最近更新（按照上传时间排序）
                Music music5 = new Music(1, "http://www.baby-cloud.com/attachments/2011/12/1_201112161602541KtvV.png","两只老虎-最近", 12000, 13000);
                Music music6 = new Music(1, "http://www.baby-cloud.com/attachments/2011/12/1_201112161602541KtvV.png", "两只老虎-最近", 12000, 13000);
