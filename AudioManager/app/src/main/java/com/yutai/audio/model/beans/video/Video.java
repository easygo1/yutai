...
public class Video implements Serializable{
	...
	private String video_upload_time;//视频上传时间
	...
	public Video(int video_id, String video_name, String video_path,
			...
			String video_upload_time, String video_remarks) {
		super();
	...
	public String toString() {
		return "Video [video_id=" + video_id + ", video_name=" + video_name
				...
				+ ", video_coins=" + video_coins + ", video_upload_time="
				+ video_upload_time + ", video_remarks=" + video_remarks + "]";
	}
