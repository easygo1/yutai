...
public class AudioPlayDAOImpl implements IAudioPlayDAO {
    ...
    public Music getMusic(int music_id) {
        //网络请求
        //根据ID得到音乐的信息
        mMusic =new Music(1,"两只老虎","http://img0.imgtn.bdimg.com/it/u=3001458640,323133104&fm=21&gp=0.jpg","http://easygo.b0.upaiyun.com/yutaimp3/shesong.mp3","http://easygo.b0.upaiyun.com/yutaimp3/shesong.lrc","幼儿故事","童话故事");
        return mMusic;
    }
}
